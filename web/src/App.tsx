  ...
  return (
    <>
      <div className="dark:bg-primary bg-white">
        <nav className="navbar ring-1 dark:ring-white/10 ring-primary/5 fixed top-0 left-0 w-full bg-white  dark:bg-secondary bg-opacity-50 text-white shadow-md z-50">
          <div className="container mx-auto px-4 py-3 flex items-center justify-between">
            <a href="#" className="text-2xl font-bold dark:text-gray-300 text-zinc-900">
              Logo
            </a>

            <button
              id="menu-toggle"
              className="lg:hidden px-3 py-2 border border-gray-300 rounded dark:text-gray-300 text-zinc-900 hover:text-white hover:border-white"
            >
              <svg
                className="w-6 h-6"
                fill="none"
            ...
            <div id="menu" className="hidden lg:flex space-x-4">
              <a href="#" className="dark:text-gray-300 text-zinc-900 px-3 py-2 rounded">
                Home
              </a>
              <a href="#" className="dark:text-gray-300 text-zinc-900 px-3 py-2 rounded">
                About
              ...
              <a onClick={() => setDarkMode(!darkMode)} href="#" className="dark:text-gray-300 text-zinc-900 px-3 py-2 rounded">
                Toggle
              </a>
            </div>
          </div>
        ...
        <section className="pt-16">
          <div className="p-4">
            <div className="grid grid-cols-1 gap-4 list-none lg:grid-cols-3 lg:grid-rows-3 xl:grid-cols-4 xl:grid-rows-4">
              <div className="lg:row-span-2 ring-1 transition-transform duration-300 ease-in-out hover:scale-95 dark:ring-white/10 ring-primary/5 bg-white dark:bg-secondary shadow-xl dark:shadow-thick rounded-3xl p-8">
                <div className="relative flex items-center gap-x-4">
                  <img
                    src="https://primapersona.lexingtonthemes.com/images/avatar.jpg"
                    alt=""
              ...
              <div className="ring-1 dark:ring-white/10 ring-primary/5 transition-transform duration-300 ease-in-out hover:scale-95 rounded-3xl justify-between shadow-xl dark:shadow-thick items-center flex flex-col p-8 h-full bg-white  dark:bg-secondary">
              ...
              <a
                ...
                className="ring-1 lg:row-span-2 transition-transform duration-300 ease-in-out hover:scale-95 flex flex-col justify-between group hover:ring-primary/10 dark:hover:ring-white/20 duration-300 h-full dark:ring-white/10 ring-primary/5 lg:row-start-2 md:grid-cols-2 md:grid lg:gap-0 md:items-center md:gap-12 lg:grid-cols-none lg:col-start-2 lg:col-span-2 rounded-3xl p-8 bg-white dark:bg-secondary shadow-xl dark:shadow-thick"
              >
                <div>
                  ...
                  <p className="mt-4 text-sm text-zinc-500 dark:text-zinc-400">
                    ...
                    <br />
                    <br />
                    Monomod streamlines the design process with a fixed monthly
                    rate and limitless design requests. Say goodbye to phone
                    calls and extensive contracts; reach out to Monomod directly
                    at any time. Embrace flexibility, pause or terminate your
              ...
              <div className="ring-1 dark:ring-white/10 transition-transform duration-300 ease-in-out hover:scale-95 ring-primary/5 flex flex-col justify-between items-center rounded-3xl shadow-xl dark:shadow-thick p-8  bg-white dark:bg-secondary overflow-hidden text-center lg:text-left">
                <div>
                  ...
                  <p className="mt-4 text-sm text-zinc-500 dark:text-zinc-400 md:max-w-xs lg:max-w-none">
                    Unlock the doors to explore the rich tapestry of my
              ...
              <a
                ...
                className="ring-1 lg:row-start-3 transition-transform duration-300 ease-in-out hover:scale-95 items-center h-full flex p-8 flex-col justify-center hover:ring-primary/5 dark:hover:ring-white/20 dark:ring-white/10 ring-primary/5 relative rounded-3xl overflow-hidden bg-white dark:bg-secondary shadow-xl dark:shadow-thick"
              >
                <svg
              ...
              <a
                ...
                className="lg:row-span-2 ring-1 transition-transform duration-300 ease-in-out hover:scale-95 dark:ring-white/10 ring-primary/5 hover:ring-primary/5 bg-white dark:bg-secondary  dark:hover:ring-white/20 overflow-hidden shadow-xl dark:shadow-thick rounded-3xl p-8"
              >
                <div className="-mr-24">
                  <img
                    src="https://primapersona.lexingtonthemes.com/images/lexington.png"
                ...
                <div className="mt-8">
                  ...
                  <p className="mt-4 text-sm text-zinc-500 dark:text-zinc-400 font-light">
                    Free and premium multipage themes and UI Kits for
                    freelancers, developers, businesses, and personal use.
                    Beautifully crafted with Astro.js, and Tailwind CSS — Simple
                    & easy to customise.
                  </p>
                </div>
              </a>
              <div className="ring-1 transition-transform duration-300 ease-in-out hover:scale-95 dark:ring-white/10 ring-primary/5 flex flex-col p-8 h-full justify-center items-center rounded-3xl overflow-hidden relative lg:col-span-2 lg:row-start-4 bg-white dark:bg-secondary shadow-xl dark:shadow-thick">
              ...
              <div className="ring-1 transition-transform duration-300 ease-in-out hover:scale-95 dark:ring-white/10 ring-primary/5 shadow-xl dark:shadow-thick rounded-3xl p-8 lg:row-start-4 h-full flex flex-col justify-between bg-white dark:bg-secondary">
              ...
              <div className="lg:col-span-2 transition-transform duration-300 ease-in-out hover:scale-95 xl:col-span-1 h-full flex flex-col justify-between lg:row-span-2 ring-1 dark:ring-white/10 ring-primary/5 bg-white dark:bg-secondary shadow-xl dark:shadow-thick rounded-3xl p-8">
